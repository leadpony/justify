...
public enum SchemaExample {
    ...
    private static final String BASE_PACKAGE = "/org/json_schema/examples/draft7/";
    ...
    public JsonValue getSchemaAsJson() {
        return readJsonFrom(getSchemaAsStream());
    }
    ...
    public JsonValue getValidInstanceAsJson() {
        return readJsonFrom(getValidInstanceAsStream());
    }

    public JsonValue getInvalidInstanceAsJson() {
