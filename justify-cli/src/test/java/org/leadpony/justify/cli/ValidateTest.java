...
public class ValidateTest {
    ...
    public static Stream<Fixture> fixtures() {
        return Stream.of(
                ...
                Fixture.of(Status.FAILED, "-s", "person-malformed.schema.json"),
                ...
                Fixture.of(Status.FAILED, "-s", "product.schema.json", "-r", "malformed.json"),
                ...
                Fixture.of(Status.FAILED, "-s", "person.schema.json", "-i", "person-malformed.json"),
