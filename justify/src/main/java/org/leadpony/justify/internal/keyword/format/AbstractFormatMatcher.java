...
abstract class AbstractFormatMatcher implements FormatMatcher {
     ...
     */
    protected final boolean backtrack(int pos) {
        this.index = pos;
        return false;
    }
     ...
     */
    protected final boolean hasNext(int expected) {
     ...
     */
    protected final String extract(int start) {
     ...
     * @return the extracted substring.
     */
    protected final String extract(int start, int end) {
