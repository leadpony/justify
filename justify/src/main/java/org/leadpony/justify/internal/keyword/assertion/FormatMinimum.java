 ...
 */
@KeywordType("formatMinimum")
@Spec(SpecVersion.AJV_EXTENSION_PROPOSAL)
@Spec(SpecVersion.DRAFT_07)
@Spec(SpecVersion.AJV_EXTENSION_PROPOSAL)
public class FormatMinimum extends AbstractTemporalAssertion {

    public FormatMinimum(JsonValue json, final String date) {
        super(json, date);
    }
    ...
    public static KeywordMapper mapper() {
        return (KeywordMapper.FromString) FormatMinimum::new;
    }
    ...
    public boolean testValue(String value) {
        try {
            ...
            return contextDateTime.isAfter(schemaDateTime) || contextDateTime.isEqual(schemaDateTime);
        } catch (Exception e) {
            return false;
        }
    }
    ...
    protected Problem createProblem(ProblemBuilder builder) {
        builder.withParameter("formatMinimum", this.date)
